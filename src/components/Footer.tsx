...
const Footer = () => {
  ...
  const handleSubscribe = async (e: React.FormEvent) => {
    ...
    // Agar aap chahte ho to yahan Supabase mein bhi save kar sakte ho
    ...
    <footer className="bg-primary text-primary-foreground">
      <div className="container mx-auto px-4 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div className="flex items-center gap-3 pt-2">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-8 h-8 rounded-lg bg-primary-foreground/10 hover:bg-accent/20 border border-primary-foreground/20 flex items-center justify-center text-primary-foreground/80 hover:text-accent transition-all duration-300 hover:scale-110"
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-bold mb-6 text-sm uppercase tracking-wider text-primary-foreground/90 border-b border-primary-foreground/20 pb-2">
              Quick Links
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3 text-sm text-primary-foreground/80 group">
                ...
                <a href="tel:+923263948677" className="hover:text-accent transition-colors">
                  +92 3263948677
                </a>
              </li>
              <li className="flex items-start gap-3 text-sm text-primary-foreground/80 group">
            ...
            <div className="mt-6">
              <p className="text-sm text-primary-foreground/70 mb-2 font-medium">Subscribe to our newsletter</p>
              <form onSubmit={handleSubscribe} className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-3 py-2 text-sm rounded-lg bg-primary-foreground/10 border border-primary-foreground/20 text-primary-foreground placeholder:text-primary-foreground/50 focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent/50"
                  disabled={isSubscribing}
                />
                <button
                  type="submit"
                  disabled={isSubscribing}
                  className="px-4 py-2 rounded-lg gradient-accent text-accent-foreground text-sm font-medium hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed"
                >
            ...
            <div className="flex items-center gap-3 md:hidden">
              {socialLinks.map((social) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-8 h-8 rounded-lg bg-primary-foreground/10 hover:bg-accent/20 flex items-center justify-center text-primary-foreground/80 hover:text-accent transition-colors"
                  aria-label={social.label}
                >
                  {social.icon}
                </a>
